...
<body>
                        ...
                        <div class="offcanvas-body justify-content-between">
                            <ul class="navbar-nav menu-list list-unstyled d-flex gap-md-3 mb-0">
                                ...
                                <li class="nav-item active">
                                    <a href="newsAPI.php" class="nav-link">News</a>
                                </li>
                            </ul>
    ...
    echo '<h1>Anime News</h1>';
        if (isset($data['data']['Page']['media'])) {
            echo '<ul class="list-group">';
            foreach ($data['data']['Page']['media'] as $anime) {
                echo '<li class="list-group-item d-flex justify-content-between align-items-center">';
                echo '<div>';
                echo '<h5>' . htmlspecialchars($anime['title']['romaji']) . '</h5>';
                echo '<small>' . htmlspecialchars($anime['title']['english']) . '</small>';
                echo '</div>';
                if (isset($anime['coverImage']['large'])) {
                    echo '<img src="' . htmlspecialchars($anime['coverImage']['large']) . '" alt="Anime Cover Image" style="width: 100px; height: 150px;">';
                }
                echo '</li>';
            }
            echo '</ul>';
        } else {
            echo '<p>No anime news available at the moment.</p>';
        }
    echo '</div>'
    ?>
