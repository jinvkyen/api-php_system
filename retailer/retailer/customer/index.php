    ...
    <div class="offcanvas-body">
      <div class="order-md-last">
        <h4 class="d-flex justify-content-between align-items-center">
          <span class="text-primary fs-2">Your cart</span>
          ...
          <ul class="list-group mb-0">
            <li class="list-group-item d-flex justify-content-between lh-sm">
              <div>
                ...
                <label for="selectAll" class="mb-3 fs-5">Select All</label>
              </div>
            </li>
            <?php
            if (isset($_SESSION['cart']) && is_array($_SESSION['cart'])) {
              foreach ($_SESSION['cart'] as $idproduct => $product) {
                if (isset($product['price'], $product['quantity'], $product['name'], $product['description'], $product['currency'])) {
                  ...
                  echo '<li class="list-group-item d-flex justify-content-between lh-sm item-row" data-product-id="' . htmlspecialchars($idproduct) . '">';
                  echo '<div>';
                  ...
                  echo '<input type="number" class="form-control form-control-sm me-2 item-quantity" name="quantity[' . htmlspecialchars($idproduct) . ']" value="' . htmlspecialchars($product['quantity']) . '" min="1" data-price="' . $product['price'] . '">';
                  echo '</div>';
                  echo '</div>';
                  echo '<span class="text-body-secondary item-total">' . htmlspecialchars($product['currency']) . ' ' . number_format($productTotal, 2) . '</span>';
                  echo '<input type="checkbox" name="select[]" value="' . htmlspecialchars($idproduct) . '" class="ms-2 item-checkbox" data-price="' . $productTotal . '">';
                  echo '</li>';
                }
              }
            } else {
    ...
    <script>
      ...
      document.querySelectorAll('.item-quantity').forEach(input => {
        input.addEventListener('change', function() {
          ...
          const totalElement = this.closest('.item-row').querySelector('.item-total');
          const checkbox = this.closest('.item-row').querySelector('.item-checkbox');

          if (quantity > 0) {
            const itemTotal = price * quantity;
            totalElement.textContent = this.closest('.item-row').querySelector('.text-body-secondary').textContent.split(' ')[0] + ' ' + itemTotal.toFixed(2);
      ...
      document.querySelectorAll('.item-row').forEach(row => {
        row.addEventListener('click', function(event) {
          if (!event.target.classList.contains('item-checkbox') && !event.target.classList.contains('item-quantity')) {
  ...
  <section id="merchandise" class="my-5 overflow-hidden" style="cursor: all-scroll;">
    <div class="container pb-5">
      <div class="section-header d-md-flex justify-content-between align-items-center mb-3">
        ...
        <div>
          <span>Cart Items: <span id="cart-count"><?php echo count($_SESSION['cart']); ?></span></span>
        </div>
      </div>
      ...
      <div class="row g-md-5 pt-4">
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">AYAKKUSU MERCH STORE is always generous to our Exclusive Members and Offers No Delivery Charge!</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">AYAKKUSU MERCH STORE offers Paypal for a Secure and Fast Transaction</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">Follow our Socials for up to date Offers and New Releases!</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 my-3">
          <div class="card">
            ...
            <div class="card-text">
              <p class="blog-paragraph fs-6">AYAKKUSU MERCH STORE is happy to spend more money on bubble wraps to Insure the Safety of our Shipped Packages</p>
            </div>
          </div>
        </div>
